...
playoff_scores = [{"ROUND": 1, "vs": "BKN", "FINAL GAME": 4, "SCORE": (150, 122)},
                  {"ROUND": 2, "vs": "BOS", "FINAL GAME": 7, "SCORE": (87, 92)}
                  ]
...
if __name__ == "__main__":
    path = "/Users/shivambhatoolaul/Documents/GitHub/guess-the-raptors-score/back-end/data/guess_playoffs_round_2.xlsx"
    ...
    guess_the_raptors_score_round_2 = PlayoffTables(round_number=2, database_path=path).get_round_table()

    print(game_table_to_html(guess_the_raptors_score_round_2, "ROUND 2 - vs. BOS"))
